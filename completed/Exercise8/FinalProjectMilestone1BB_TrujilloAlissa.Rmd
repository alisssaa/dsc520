...
For my final project in DSC 520, I will be delving into data regarding
...
involved fan base, it seems that those who watch the show are very
passionate about it rather than being casual fans. I think this data
would be very interesting for those who watch this show or are
interested in applying to be on the show. It is a data science problem
because I will be analyzing the wealth of data that exists regarding the
show and past house guests. I will be taking observations of many
variables into account in order to determine trends and correlations
that exist in the data, and I will use that to make predictions
regarding future house guests and how they will fare in the game.
...
-   Are there any correlations between players surviving the block
    (being nominated many times but surviving) and lasting longer in the
    game?
...
similar to each other, or if there are significant differences between
what makes a player likely to make it far versus winning the whole game.
Once I am able to calculate the correlations, I will see if there is any
way to prove causation in one direction or another.
...
likely to be a winner really hold up. It is a common belief that winning
...
pieces of information about each of the 370 house guests that the show
has had over the last 23 seasons. The original data was compiled by a
Kaggle user in order to do a research project on diversity in the show.
This data has been continuously updated so that it inlcudes the most
...
This data set was compiled by the same Kaggle user as the first data set
I have presented. This set of data focuses on the racial diversity of
each individual season. It provides breakdowns of each race's
